...
func TestParseVirtualMachineExtensionID(t *testing.T) {
	testData := []struct {
		Name     string
		Input    string
		Expected *VirtualMachineExtensionResourceID
	}{
		{
			Name:     "Empty",
			Input:    "",
		...
		},
		{
			...
			Input:    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/foo/virtualMachines/example1",
			Expected: nil,
		},
		{
			Name:     "No Virtual Machine Scale Set Extensions Value",
			Input:    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/foo/virtualMachines/example1/extensions/",
			Expected: nil,
		},
		{
			Name:  "Completed",
			Input: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/foo/virtualMachines/example1/extensions/example2",
			Expected: &VirtualMachineExtensionResourceID{
				Name:               "example2",
