...
The deprecated field `location` will be removed - this is now pulled from the Virtual Machine specified in `virtual_machine_id`.

The deprecated field `resource_group_name` will be removed - this has been superseded by `virtual_machine_id`.

The deprecated field `virtual_machine_name` will be removed - this has been superseded by `virtual_machine_id`.
